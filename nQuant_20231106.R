  ...
  for (b in 1:5){                                                       #Range of charge states 
    ...
    for (c in RetTimeIndex){
      ...
      if (between(t,NglycanList$Start1[a]*60,NglycanList$End1[a]*60) | between(t,NglycanList$Start2[a]*60,NglycanList$End2[a]*60)) {
         ...
         C<-NglycanList$Neu5Gc[a]*19+NglycanList$Neu5Ac[a]*18+NglycanList$HexNAc[a]*13+NglycanList$Hex[a]*11+NglycanList$Fuc[a]*10+NglycanList$Red_HexNAc[a]*14-(NglycanList$Neu5Gc[a]+NglycanList$Neu5Ac[a]+NglycanList$HexNAc[a]+NglycanList$Hex[a]+NglycanList$Fuc[a])*2
         H<-NglycanList$Neu5Gc[a]*35+NglycanList$Neu5Ac[a]*33+NglycanList$HexNAc[a]*25+NglycanList$Hex[a]*22+NglycanList$Fuc[a]*20+NglycanList$Red_HexNAc[a]*29-(NglycanList$Neu5Gc[a]+NglycanList$Neu5Ac[a]+NglycanList$HexNAc[a]+NglycanList$Hex[a]+NglycanList$Fuc[a])*6
         N<-NglycanList$Neu5Gc[a]+NglycanList$Neu5Ac[a]+NglycanList$HexNAc[a]+NglycanList$Red_HexNAc[a]
         O<-NglycanList$Neu5Gc[a]*10+NglycanList$Neu5Ac[a]*9+NglycanList$HexNAc[a]*6+NglycanList$Hex[a]*6+NglycanList$Fuc[a]*5+NglycanList$Red_HexNAc[a]*6-(NglycanList$Neu5Gc[a]+NglycanList$Neu5Ac[a]+NglycanList$HexNAc[a]+NglycanList$Hex[a]+NglycanList$Fuc[a])
      ...
      if (between(t,NglycanList$Start1[a]*60,NglycanList$End1[a]*60) | between(t,NglycanList$Start2[a]*60,NglycanList$End2[a]*60)) {
        ...
        for (d in Row1:Row2){
          ...
          if (abs(Err_12C[Min1])<=5 & abs(Err_13C[Min2])<=5){
            ...
            C13<-NglycanList$Neu5Gc[a]*8+NglycanList$Neu5Ac[a]*7+NglycanList$HexNAc[a]*5+NglycanList$Hex[a]*5+NglycanList$Fuc[a]*4+NglycanList$Red_HexNAc[a]*6-(NglycanList$Neu5Gc[a]+NglycanList$Neu5Ac[a]+NglycanList$HexNAc[a]+NglycanList$Hex[a]+NglycanList$Fuc[a])*2
            C12<-C-C13
